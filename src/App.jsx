  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ffffff", color: "#1e293b", padding: "40px 24px", fontFamily: "'DM Sans', sans-serif", position: "relative" }}>
      ...
      <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, zIndex: 0, pointerEvents: "none" }}>
        ...
        {/* Bar chart — top left */}
        <svg style={{ position: "absolute", top: "20px", left: "20px", opacity: 0.1 }} width="200" height="150" xmlns="http://www.w3.org/2000/svg">
          <line x1="10" y1="130" x2="195" y2="130" stroke="#64748b" strokeWidth="1.5"/>
          <line x1="10" y1="10" x2="10" y2="130" stroke="#64748b" strokeWidth="1.5"/>
          <line x1="10" y1="100" x2="195" y2="100" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <line x1="10" y1="65" x2="195" y2="65" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <line x1="10" y1="35" x2="195" y2="35" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <rect x="18" y="75" width="26" height="55" fill="#0f766e" rx="2"/>
          <rect x="52" y="50" width="26" height="80" fill="#0f766e" rx="2"/>
          <rect x="86" y="62" width="26" height="68" fill="#e85d4a" rx="2"/>
          <rect x="120" y="28" width="26" height="102" fill="#0f766e" rx="2"/>
          <rect x="154" y="42" width="26" height="88" fill="#e85d4a" rx="2"/>
        </svg>

        {/* Line chart — top right */}
        <svg style={{ position: "absolute", top: "20px", right: "20px", opacity: 0.1 }} width="220" height="150" xmlns="http://www.w3.org/2000/svg">
          <line x1="10" y1="130" x2="210" y2="130" stroke="#64748b" strokeWidth="1.5"/>
          <line x1="10" y1="10" x2="10" y2="130" stroke="#64748b" strokeWidth="1.5"/>
          <line x1="10" y1="100" x2="210" y2="100" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <line x1="10" y1="65" x2="210" y2="65" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <line x1="10" y1="35" x2="210" y2="35" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <polyline points="15,110 55,85 95,95 135,55 170,65 205,28" fill="none" stroke="#0f766e" strokeWidth="2.5" strokeLinejoin="round" strokeLinecap="round"/>
          <polyline points="15,118 55,105 95,112 135,82 170,90 205,58" fill="none" stroke="#e85d4a" strokeWidth="1.5" strokeLinejoin="round" strokeLinecap="round" strokeDasharray="6,3"/>
          <circle cx="15" cy="110" r="4" fill="#0f766e"/>
          <circle cx="55" cy="85" r="4" fill="#0f766e"/>
          <circle cx="95" cy="95" r="4" fill="#0f766e"/>
          <circle cx="135" cy="55" r="4" fill="#e85d4a"/>
          <circle cx="170" cy="65" r="4" fill="#0f766e"/>
          <circle cx="205" cy="28" r="4" fill="#0f766e"/>
        </svg>

        {/* Pie chart — bottom left */}
        <svg style={{ position: "absolute", bottom: "20px", left: "20px", opacity: 0.1 }} width="160" height="160" xmlns="http://www.w3.org/2000/svg">
          <circle cx="80" cy="80" r="75" fill="#f1f5f9"/>
          <path d="M80,80 L80,5 A75,75 0 0,1 155,80 Z" fill="#0f766e"/>
          <path d="M80,80 L155,80 A75,75 0 0,1 42.5,144.9 Z" fill="#e85d4a"/>
          <path d="M80,80 L42.5,144.9 A75,75 0 0,1 5,56.5 Z" fill="#0f766e" opacity="0.55"/>
          <path d="M80,80 L5,56.5 A75,75 0 0,1 80,5 Z" fill="#64748b" opacity="0.4"/>
          <circle cx="80" cy="80" r="30" fill="white" opacity="0.6"/>
        </svg>

        {/* Scatter plot — bottom right */}
        <svg style={{ position: "absolute", bottom: "20px", right: "20px", opacity: 0.1 }} width="200" height="160" xmlns="http://www.w3.org/2000/svg">
          <line x1="10" y1="140" x2="195" y2="140" stroke="#64748b" strokeWidth="1.5"/>
          <line x1="10" y1="10" x2="10" y2="140" stroke="#64748b" strokeWidth="1.5"/>
          <line x1="10" y1="105" x2="195" y2="105" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <line x1="10" y1="70" x2="195" y2="70" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <line x1="10" y1="38" x2="195" y2="38" stroke="#94a3b8" strokeWidth="0.8" strokeDasharray="5,5"/>
          <circle cx="28" cy="122" r="6" fill="#0f766e"/>
          <circle cx="52" cy="100" r="8" fill="#e85d4a"/>
          <circle cx="75" cy="112" r="5" fill="#0f766e"/>
          <circle cx="95" cy="78" r="9" fill="#0f766e"/>
          <circle cx="118" cy="88" r="6" fill="#e85d4a"/>
          <circle cx="140" cy="52" r="7" fill="#0f766e"/>
          <circle cx="162" cy="62" r="5" fill="#e85d4a"/>
          <circle cx="182" cy="30" r="8" fill="#0f766e"/>
          <circle cx="62" cy="130" r="4" fill="#64748b"/>
          <circle cx="105" cy="118" r="6" fill="#0f766e"/>
          <circle cx="148" cy="96" r="5" fill="#e85d4a"/>
        </svg>
